...
const checker = (item, arr) => arr.every(el => {
...
export const useSearchStore = defineStore("search", {
  state: () => ({
    ...
    },
    {
        "id": 22,
        "title": "Плеяды",
        "address": "Автосалон: г. Калининград, Московский проспект д. 242 Сервис: г. Калининград, ул. Ялтинская 66А"
    },
    {
        "id": 23,
    ...
    },
    {
        ...
        "address": "Республика Татарстан , Набережные Челны г, пр-т Хасана Туфана, 3Б"
    },
    {
        "id": 31,
    ...
    },
    {
        ...
        "address": "443080, Самарская область, г. Самара, ул. Революционная, 70, литер 38, 38-1, 38-2"
    },
    {
        "id": 41,
        "title": "Успех Авто +",
  ...
  getters: {
    ...
    splitToArray(state) {
      return [...new Set(state.request.toLowerCase().split(' ').filter(item => item))]
    },
    requestWords(state) {
